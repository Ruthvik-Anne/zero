...
import type { ExtensionAPI, ExtensionCommandContext, Theme } from "@zero-agent/coding-agent";
import type { Component, OverlayAnchor, OverlayHandle, OverlayOptions, TUI } from "@zero-agent/tui";
import { matchesKey, truncateToWidth, visibleWidth } from "@zero-agent/tui";
