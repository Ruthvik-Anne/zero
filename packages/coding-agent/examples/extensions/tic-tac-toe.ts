...
import type { ExtensionAPI, ExtensionContext, Theme, ToolExecutionMode } from "@zero-agent/coding-agent";
import { type Component, matchesKey, Text, truncateToWidth, visibleWidth } from "@zero-agent/tui";
