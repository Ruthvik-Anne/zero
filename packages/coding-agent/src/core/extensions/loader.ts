...
function getAliases(): Record<string, string> {
	...
	const piAgentCoreEntry = resolveWorkspaceOrImport("agent/dist/index.js", "@zero-agent/agent-core");
	const piTuiEntry = resolveWorkspaceOrImport("tui/dist/index.js", "@zero-agent/tui");
	const piAiEntry = resolveWorkspaceOrImport("ai/dist/index.js", "@zero-agent/ai");
	const piAiOauthEntry = resolveWorkspaceOrImport("ai/dist/oauth.js", "@zero-agent/ai/oauth");

	_aliases = {
		"@zero-agent/coding-agent": piCodingAgentEntry,
		"@zero-agent/agent-core": piAgentCoreEntry,
		"@zero-agent/tui": piTuiEntry,
		"@zero-agent/ai": piAiEntry,
		"@zero-agent/ai/oauth": piAiOauthEntry,
