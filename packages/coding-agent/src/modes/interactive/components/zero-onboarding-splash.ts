import { type Component, getKeybindings, truncateToWidth, visibleWidth } from "@zero-agent/tui";
import { ZERO_LOGO } from "../../../themes/zero-logo.js";
import { type ThemeColor, theme } from "../theme/theme.js";

interface ZeroOnboardingSplashOptions {
	getRows?: () => number;
	requestRender?: () => void;
...
const LOGO_LINES = ZERO_LOGO.split("\n");
...
export class ZeroOnboardingSplashComponent implements Component {
	private frame = 0;
	...
	constructor(
		...
		private readonly options: ZeroOnboardingSplashOptions = {},
	) {
	...
	private formatContinueHint(): PanelTextLine {
		...
		const actionLabel = this.options.continueActionLabel ?? "get started";
		return [
