...
describe("totalTokens field", () => {
	...
	describe.skipIf(!process.env.GEMINI_API_KEY)("Google", () => {
		// gemini-2.0-flash was removed from the live models.dev catalog; swapped to
		// the current equivalent tier so this still type-checks against the
		// regenerated model union.
		it(
